...
\newcounter{rqctr}
\newenvironment{rquestion}{%      define a custom environment
   \bigskip\noindent%         create a vertical offset to previous material
   \refstepcounter{rqctr}% increment the environment's counter
   \textbf{Research Question \therqctr}% or \textbf, \textit, ...
   \newline%
   }{\par\bigskip}  %          create a vertical offset to following material
% \numberwithin{rqctr}{chapter}
...
\newcommand{\vdata}{\texttt{v\_data}}
\newcommand{\uint}{\texttt{unsigned int}}
...
\include{chapters/par_slashburn}

%\include{model}
%\include{impl}
\include{chapters/rhubarb}
